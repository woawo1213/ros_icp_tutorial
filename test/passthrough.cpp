...
{
    std::string read_file_name="table_top.pcd";
    ...
    pcl::io::loadPCDFile<pcl::PointXYZRGB> (file_path+read_file_name, *cloud);
    ...
    // 저장 
    pcl::io::savePCDFile<pcl::PointXYZRGB>(file_path+write_file_name, *cloud_filtered); //Default binary mode save
