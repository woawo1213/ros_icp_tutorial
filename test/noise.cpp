...
main (int argc, char** argv)
{
    ...
    // std::string write_file_name="table_top_passthrough.pcd";
    ...
    reader.read<pcl::PointXYZ> (file_path+read_file_name, *cloud);
    ...
    writer.write<pcl::PointXYZ> (file_path+"table_scene_lms400_inlier.pcd", *cloud_filtered, false);

    // 생성된 포인트클라우드(outlier) 저장 
    sor.setNegative (true);
    sor.filter (*cloud_filtered);
    writer.write<pcl::PointXYZ> (file_path+"table_scene_lms400_outlier.pcd", *cloud_filtered, false);
